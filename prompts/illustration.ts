...
/**
 * Claude Haiku에게 "이 소설의 한 장면을 애니메이션 일러스트 프롬프트로 만들어줘"
 * 라고 지시하는 시스템 프롬프트.
 *
...
2. 스타일은 고정입니다: "anime illustration, cel shading, soft lighting, detailed background, studio ghibli inspired, high quality, 2D"
...
8. **출력은 프롬프트 본문 그 자체만** 포함해야 합니다. 설명, 머리말, 따옴표, 마크다운 금지.
`;
}
